...
class LauncherSettings {
    ...
    static final class Favorites implements BaseLauncherColumns {
        ...
        /**
         * The favorite is a live folder Note: live folders can no longer be
         * added to Launcher, and any live folders which exist within the
         * launcher database will be ignored when loading. That said, these
         * entries in the database may still exist, and are not automatically
         * stripped.
         */
