...
public class LauncherAppState {
    private static final String TAG = JLog.makeTag(LauncherAppState.class);

    private static final String SHARED_PREFERENCES_KEY = "com.joysee.portal.launcher.prefs";
    ...
    private static LauncherAppState mAppState;
    ...
    public static LauncherAppState getInstance() {
        if (mAppState == null) {
            synchronized (obj) {
                if (mAppState == null) {
                    mAppState = new LauncherAppState();
                }
            }
        }
        return mAppState;
